...
#ifndef user_AppComponent_hpp
#define user_AppComponent_hpp
...
class AppComponent {
 ...
 public:
  ...
  OATPP_CREATE_COMPONENT(std::shared_ptr<
                        ...
                        Qualifiers::SERVICE_USER_VH, [] {
    OATPP_COMPONENT(std::shared_ptr<oatpp::network::virtual_::Interface>,
                        interface, Qualifiers::SERVICE_USER);
    return oatpp::network::virtual_::server::ConnectionProvider::
                        createShared(interface);
  }());
  ...
  OATPP_CREATE_COMPONENT(std::shared_ptr<oatpp::web::server::HttpRouter>,
                        httpRouter)(Qualifiers::SERVICE_USER, [] {
